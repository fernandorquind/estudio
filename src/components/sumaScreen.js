...
const SumaScreen = () => {
  ...
  async function getSum() {
    console.log("entro");
    axios
      .get("https://backcalculatorf.herokuapp.com/suma", {
        params: {
          op1: op1Internal,
          op2: op2Internal,
        },
      ...
      >
        <Col xs={12} md={6} className="mb-4">
          <Card bg="dark" className="text-light">
            <Card.Header><h3>Sumar</h3></Card.Header>
            <Card.Body>
              <Form>
        ...
        <Col xs={12} md={6} className="mb-4">
          <Card bg="dark">
            ...
            <Card.Body>
              <Card.Title className="text-light">Suma</Card.Title>
              <div>
